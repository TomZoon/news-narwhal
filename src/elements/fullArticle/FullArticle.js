	...
	return (
		<div className='fullArticle'>
			<div className='topBar'>
				...
				<span className="dot">•</span>
				{ authorDiv }
				<a href={props.article.url}>{ props.article.source.name }</a>
			</div>
			...
			<br/>
			<div className="content">{ props.article.content }
				...
				<br/><br/>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
				...
				<br/><br/>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
